...
void StickersManager::memory_stats(vector<string> &output) {
  output.push_back("\"stickers_\":"); output.push_back(std::to_string(this->stickers_.calc_size()));
  output.push_back(",");
  output.push_back("\"sticker_sets_\":"); output.push_back(std::to_string(this->sticker_sets_.calc_size()));
  output.push_back(",");
  ...
  output.push_back(",");
  output.push_back("\"load_favorite_stickers_queries_\":"); output.push_back(std::to_string(this->load_favorite_stickers_queries_.size()));
  output.push_back(",");
  output.push_back("\"repair_favorite_stickers_queries_\":"); output.push_back(std::to_string(this->repair_favorite_stickers_queries_.size()));
  output.push_back(",");
  output.push_back("\"sticker_set_reload_queries_\":"); output.push_back(std::to_string(this->sticker_set_reload_queries_.size()));
  output.push_back(",");
  output.push_back("\"favorite_sticker_file_ids_\":"); output.push_back(std::to_string(this->favorite_sticker_file_ids_.size()));
  output.push_back(",");
  output.push_back("\"attached_sticker_sets_\":"); output.push_back(std::to_string(this->attached_sticker_sets_.size()));
  output.push_back(",");
  output.push_back("\"pending_viewed_featured_sticker_set_ids_\":"); output.push_back(std::to_string(this->pending_viewed_featured_sticker_set_ids_.size()));
  output.push_back(",");
  output.push_back("\"special_sticker_sets_\":"); output.push_back(std::to_string(this->special_sticker_sets_.size()));
  output.push_back(",");
  output.push_back("\"sticker_set_load_requests_\":"); output.push_back(std::to_string(this->sticker_set_load_requests_.size()));
  output.push_back(",");
  output.push_back("\"custom_emoji_load_queries_\":"); output.push_back(std::to_string(this->custom_emoji_load_queries_.size()));
  output.push_back(",");
  output.push_back("\"pending_new_sticker_sets_\":"); output.push_back(std::to_string(this->pending_new_sticker_sets_.size()));
  output.push_back(",");
  output.push_back("\"pending_add_sticker_to_sets_\":"); output.push_back(std::to_string(this->pending_add_sticker_to_sets_.size()));
  output.push_back(",");
  output.push_back("\"pending_set_sticker_set_thumbnails_\":"); output.push_back(std::to_string(this->pending_set_sticker_set_thumbnails_.size()));
  output.push_back(",");
  output.push_back("\"pending_get_animated_emoji_queries_\":"); output.push_back(std::to_string(this->pending_get_animated_emoji_queries_.size()));
  output.push_back(",");
  output.push_back("\"pending_get_premium_gift_option_sticker_queries_\":"); output.push_back(std::to_string(this->pending_get_premium_gift_option_sticker_queries_.size()));
  output.push_back(",");
  output.push_back("\"pending_get_generic_animations_queries_\":"); output.push_back(std::to_string(this->pending_get_generic_animations_queries_.size()));
  output.push_back(",");
  output.push_back("\"pending_get_default_statuses_queries_\":"); output.push_back(std::to_string(this->pending_get_default_statuses_queries_.size()));
  output.push_back(",");
  output.push_back("\"pending_get_default_channel_statuses_queries_\":"); output.push_back(std::to_string(this->pending_get_default_channel_statuses_queries_.size()));
  output.push_back(",");
  ...
  output.push_back(",");
  output.push_back("\"emoji_language_codes_\":"); output.push_back(std::to_string(this->emoji_language_codes_.size()));
  output.push_back(",");
  output.push_back("\"emoji_language_code_versions_\":"); output.push_back(std::to_string(this->emoji_language_code_versions_.size()));
  output.push_back(",");
  output.push_back("\"emoji_language_code_last_difference_times_\":"); output.push_back(std::to_string(this->emoji_language_code_last_difference_times_.size()));
  output.push_back(",");
  output.push_back("\"reloaded_emoji_keywords_\":"); output.push_back(std::to_string(this->reloaded_emoji_keywords_.size()));
  output.push_back(",");
  output.push_back("\"load_emoji_keywords_queries_\":"); output.push_back(std::to_string(this->load_emoji_keywords_queries_.size()));
  output.push_back(",");
  ...
  output.push_back(",");
  output.push_back("\"dice_quick_reply_messages_\":"); output.push_back(std::to_string(this->dice_quick_reply_messages_.size()));
  output.push_back(",");
  output.push_back("\"emoji_messages_\":"); output.push_back(std::to_string(this->emoji_messages_.size()));
  output.push_back(",");
  output.push_back("\"custom_emoji_messages_\":"); output.push_back(std::to_string(this->custom_emoji_messages_.size()));
  output.push_back(",");
  output.push_back("\"dice_emojis_\":"); output.push_back(std::to_string(this->dice_emojis_.size()));
  output.push_back(",");
  output.push_back("\"dice_success_values_\":"); output.push_back(std::to_string(this->dice_success_values_.size()));
  output.push_back(",");
  output.push_back("\"emoji_sounds_\":"); output.push_back(std::to_string(this->emoji_sounds_.size()));
  output.push_back(",");
  output.push_back("\"custom_emoji_to_sticker_id_\":"); output.push_back(std::to_string(this->custom_emoji_to_sticker_id_.calc_size()));
}
